...
the interest in photo voltaic (PV) arrays grows as well. \todo[color=c01]{find source}
Solar power is a growing source of renewable energy on a global scale \cite{solglob}. \todo[color=c01]{find source}
This can be indicated by the growing interest power companies show in building PV parks. \cite{solpowcomp}. \todo[color=c01]{find source}
