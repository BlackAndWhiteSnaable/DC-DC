...
The operation of all three topologies is described in the different switching modes and their conversion ratios are derived using the KVL method. \todo {reword}
