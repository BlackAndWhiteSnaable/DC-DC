...
\begin{figure}[H]
   \centering
   \includegraphics[width=0.7\textwidth]{figures/aConventionalBoost/LvAndLi.eps}
...
Inductance(L)          &      120$\mu$H      \\ \cline{1-2}
...
\begin{figure}[H]%
    ...
    \qquad
    \subfloat{{\includegraphics[width=0.8\textwidth]{figures/aConventionalBoost/CBC_I_CtoI_out.eps} }}%  
