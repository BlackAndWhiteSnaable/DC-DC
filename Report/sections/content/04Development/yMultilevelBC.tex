...
\subsubsection{Inverting Nx Multilevel BC}

The Inverting Nx Multilevel Boost Converter can be achieved similar to the non-inverting one, but this time the Cockroft Walton Multiplier is substracted as shown on Figure~\ref{fig:MBC_InvertingNxDiagram}
